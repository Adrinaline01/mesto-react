...
function PopupWithForm({ isOpen, name, title, onClose, textButton, onSubmit, nameProfile, ...props }) {
  ...
  return (
    <div className={`popup popup_${name} ${isOpen && 'popup_opened'}`}>
      <div className={`popup__container popup__container_${name}`}>
        ...
        <form className={`popup__form popup__form_${name}`} name={nameProfile} onSubmit={onSubmit}>
          {props.children}
